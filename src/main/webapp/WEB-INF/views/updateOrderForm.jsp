		...
		<div class="container col-md-10 mt-5">
			<div class="card">
				<div class="card-body">
					...
					<form:form action="${pageContext.request.contextPath}/update" method="put" modelAttribute="order">
						...
						<caption>
							...
							<input type="hidden" name="orderDatePlus"
							value="<c:out value='${order.orderDatePlus}' />" />	
						
						<div class="mb-4 row">
							<fieldset class="form-group col-md-4">
								<form:label path="orderCategory">訂單類別:</form:label>
								<form:select class="form-select" path="orderCategory">
									<form:option value="訂房">訂房</form:option>
									<form:option value="訂票">訂票</form:option>
								</form:select>
							</fieldset>
							<fieldset class="form-group col-md-4">
								<form:label path="userNo">會員編號:</form:label>
								<form:input type="text" class="form-control" path="userNo"
									id="userno" />
							</fieldset>
						</div>
						<div class="mb-4 row">
							<fieldset class="form-group col-md-4">
								<form:label path="orderTotal">總價:</form:label>
								<form:input type="text" class="form-control" path="orderTotal"
									id="total" />
							</fieldset>
							<fieldset class="form-group col-md-4">
								<form:label path="orderDiscount">折扣金額:</form:label>
								<form:input type="text" class="form-control"
									path="orderDiscount" readOnly="true" id="discount" />
							</fieldset>
							<fieldset class="form-group col-md-4">
								<form:label path="couponId">折扣類別:</form:label>
								<form:select class="form-select" path="couponId" id="couponId">
						...
						<div class="mb-2 row">
							...
							<fieldset class="form-group col-md-4">
								<form:label path="orderStatus">訂單狀態:</form:label>
								<form:select class="form-select" path="orderStatus">
							...
							<fieldset class="form-group col-md-4">
								<form:label path="orderPayStatus">付款狀態:</form:label>
								<form:select class="form-select" path="orderPayStatus">
